    ...
    where TModelType : DbEntity
{
    ...
    public TModelType Get(Guid id) => _session.Get<TModelType>(id);
    ...
    public async Task<TModelType> GetAsync(Guid id) => await _session.GetAsync<TModelType>(id);
    ...
    public void Update(TModelType entity) => _session.Update(entity);
    ...
    /// <param name="entity">Сущность для обновления</param>
    /// <returns>Задача, представляющая асинхронную операцию</returns>
    public async Task UpdateAsync(TModelType entity) => await _session.MergeAsync(entity);
    
    /// <summary>
    /// Удаляет сущность из базы данных
    /// </summary>
    /// <param name="entity">Сущность для удаления</param>
    public void Delete(TModelType entity) => _session.Delete(entity);
    ...
    /// <param name="entity">Сущность для удаления</param>
    /// <returns>Задача, представляющая асинхронную операцию</returns>
    public async Task DeleteAsync(TModelType entity) => await _session.DeleteAsync(entity);
